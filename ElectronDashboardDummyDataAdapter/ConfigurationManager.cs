...
namespace ElectronDashboardDummyDataAdapter
{
    public class ConfigurationManager
    {
        ...
        public string configFilename = "configFilename.json";
        ...
        public void Initialize()
        {
            ...
            {
                ConfigurationManager wbesArchConfig = JsonConvert.DeserializeObject<ConfigurationManager>(File.ReadAllText(jsonPath));
                CloneFromObject(wbesArchConfig);
            }
            else
            {
                Save();
